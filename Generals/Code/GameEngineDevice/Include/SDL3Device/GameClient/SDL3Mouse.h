...
// Project:    RTS3
//
// File name:  LinuxMouse.h
//
// Created:    Cristiano Beato, June 2025
//
// Desc:       Interface for the mouse using only the SDL messages
//
//-----------------------------------------------------------------------------
///////////////////////////////////////////////////////////////////////////////
...
public:
	...
	void addSDL3Event( UINT msg, WPARAM wParam, LPARAM lParam, DWORD time );
